...
----------------
    ...
    - hosts: servers
      roles:
         - { role: RogersCompany.config-interfaces }

Example /etc/network/interfaces generated from the example variables
--------------------------------------------------------------------
````
# Ansible managed: /etc/ansible/roles/RogersCompany.config-interfaces/templates/etc/network/interfaces.j2 modified on 2015-10-16 21:21:14 by root on node-1
